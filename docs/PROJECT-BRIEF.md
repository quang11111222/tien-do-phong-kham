...
20. Header có chuông thông báo riêng theo từng tài khoản; tách **Cập nhật mới** (giao việc, diễn biến, gửi hoàn thành, duyệt/từ chối) và **Cần chú ý** (sắp đến hạn/quá hạn). Cập nhật mới giữ 20 sự kiện gần nhất sau khi lọc loại/phạm vi; hiển thị trong khung cuộn gọn, không phân trang. Bấm thông báo mở đúng dự án/công việc; đánh dấu đã đọc chỉ áp dụng cho cập nhật, không xóa lời nhắc còn cần xử lý.
20a. Theo dõi kế hoạch và thực tế: không nhập ngày bắt đầu thực tế riêng; ngày bắt đầu thực tế mặc định bằng ngày bắt đầu kế hoạch. Khi người dùng nộp hoàn thành sau khi đã có đủ bằng chứng, hệ thống chỉ ghi nhận thời điểm nộp làm ngày kết thúc thực tế nếu lượt nộp đó được duyệt. Nếu nộp sau ngày kết thúc kế hoạch, bắt buộc nhập lý do trễ; lý do được lưu cùng lượt nộp để người duyệt xem xét. Nếu bị từ chối, công việc chưa kết thúc thực tế và tiếp tục tính quá hạn cho đến khi có lượt nộp được duyệt.
...
- Tại màn Quản lý người dùng, trường gắn Phòng/ban và cột Phòng/ban chỉ hiển thị tên đầy đủ; mã phòng/ban vẫn được giữ trong dữ liệu và ở các vị trí cần nhận diện ngắn gọn như thẻ tài khoản.
