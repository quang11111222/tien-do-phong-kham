...
const request = (overrides: Partial<CompletionRequest> = {}): CompletionRequest => ({ id: 'request', work_item_id: 'work', attempt_no: 1, note: null, late_reason: null, status: 'pending', submitted_by: 'other', submitted_at: '2026-09-15T00:00:00Z', work_item: { id: 'work', project_id: 'project-a', wbs: '1', name: 'Work', lead_department_id: 'dept-a' }, ...overrides })
